...
static const char *const yytname[] =
{
  ...
  "statement_list", "statement", "line_statement", "point_statement",
  "circle_statement", "rectangle_statement", "color_statment", YY_NULLPTR
};
#endif
...
#line 62 "zoomjoystrong.y" /* yacc.c:1646  */
    {
		...
		if((yyvsp[-4].i) >= 0 && (yyvsp[-3].i) >= 0 && (yyvsp[-2].i) >= 0 && (yyvsp[-1].i) >= 0){
			   if((yyvsp[-4].i) <= WIDTH  && (yyvsp[-3].i) <= HEIGHT && (yyvsp[-2].i) <= WIDTH && (yyvsp[-1].i) <= HEIGHT){
...
#line 79 "zoomjoystrong.y" /* yacc.c:1646  */
    {
		if((yyvsp[-2].i) > 0 && (yyvsp[-1].i) > 0){
		 	if((yyvsp[-2].i) <= WIDTH  && (yyvsp[-1].i) <=  HEIGHT){
...
#line 92 "zoomjoystrong.y" /* yacc.c:1646  */
    {
		if((yyvsp[-3].i) >= 0 && (yyvsp[-2].i) >=0){
		if((yyvsp[-3].i) <= WIDTH && (yyvsp[-2].i) <= HEIGHT){
...
#line 113 "zoomjoystrong.y" /* yacc.c:1646  */
    {
		 if((yyvsp[-3].i) >= 0 && (yyvsp[-2].i) >= 0 && (yyvsp[-1].i) >= 0){
			if((yyvsp[-3].i)<=255 && (yyvsp[-2].i)<=255 && (yyvsp[-1].i)<=255){
